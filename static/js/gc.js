...
loadScript(base + '/static/js/bm/jquery-and-ui.min.js', function() {
	...
	var css = {
			...
			div:     'z-index:99999;position:absolute;top:50px;left:50px;width:530px;background:#fff;border:1px solid #000',
		...
		logo = '<a href="' + base + '"><img style="padding:15px 0 0 40px" src="' + base + '/img/logo-beta.png" alt="Gift Circle" /></a>',

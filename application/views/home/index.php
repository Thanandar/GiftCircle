	...
	<div class="row home-list">
		...
		<div class="span8">
			<ol class="right">
				...
				<li>
					<h4>No more worry that you've bought enough</h4>
					<p>With all gift ideas clearly detailed on your shopping list, you can easily make sure that everyone is taken care of.</p>
				</li>
				<li>
